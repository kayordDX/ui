<script lang="ts" module>
	...
	export const bubbleVariants = tv({
		base: "max-w-[80%] gap-1 group-data-[align=end]/message:self-end data-[align=end]:self-end data-[variant=ghost]:max-w-full group/bubble relative flex w-fit min-w-0 flex-col",
		variants: {
			variant: {
